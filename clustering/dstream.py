...
class DStreamEventClusterer:
    def __init__(self, sensor_width=346, sensor_height=260, grid_size=5, 
                 tau_us=50000, dense_threshold=10, update_interval_us=5000, medium_density_threshold=5):
        """
        Parameters:
...
df.to_parquet('data/val_day_014_td_dstream.parquet')  # Save the results for later analysis
