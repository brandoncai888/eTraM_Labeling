...
if __name__ == "__main__":
    ...
    clustered = cluster_events_stdbscan(
        ...
        eps_temporal=20000.0,   # µs  (adjust to match your timestamp unit)
        min_pts=100,
        use_gpu=True,
        chunk_size=700_000,     # prevent cuML int32 overflow on large datasets
        overlap=50_000,         # some events shared between windows to stitch clusters
